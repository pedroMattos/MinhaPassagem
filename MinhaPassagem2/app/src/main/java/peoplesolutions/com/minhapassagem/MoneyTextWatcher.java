...
public class MoneyTextWatcher implements TextWatcher {
    ...
    public double parseMaskToDouble(EditText editText){
        String recover = editText.getText().toString().replace("R$", "")
                .replace(",", "");
        String removeBlackSpacing = recover.replaceAll("^\\s+", "");
        Double parseDouble = Double.parseDouble(removeBlackSpacing);
        return parseDouble;
    }
}
